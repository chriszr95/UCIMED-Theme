			...
			{if $publication->getData('authors')}
						...
						{strip}
							<li>
								...
								<a class="author-string-href" href="#author-{$authorStringKey+1}">
									...
									<span class="author-symbol author-plus"> &plus;</span>
									<span class="author-symbol author-minus hide"> &minus;</span>								
								</a>
								{else}
								<span>{$authorString->getFullName()|escape}</span>
								{/if}
				...
				<div class="article-details-authors">
					{foreach from=$publication->getData('authors') item=author key=authorKey}
						<div class="article-details-author hideAuthor fixColor" id="author-{$authorKey+1}">
